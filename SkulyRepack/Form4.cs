...
namespace SkulyRepack
{
    public partial class Form4 : Form
    {
        ...
        {
            InitializeComponent();
            var killmysql1 = new Process();
            var killmysqld1 = "/C " + "taskkill /f /im mysqld.exe";
        ...
        public void button1_Click(object sender, EventArgs e)
        {
            if (button1.Text == "Start")
            {
                ...
                var Procmysql = "mysqld";
                var procmysqld = Process.GetProcessesByName(Procmysql);
                ...
                if ((procmysqld.Length != 0))
                {
                    ...
                    var path = @"MySQL\bin\AccountBackup";
                    ...
                    mysqldump.StartInfo.Arguments = "-u root --password=root acore_auth account account_access account_banned account_muted realmcharacters --result-file=" + @"MySQL\bin\AccountBackup\AuthDB.sql";
                    ...
                    var killmysql = new Process();
                    var killmysqld = "/C " + "taskkill /f /im mysqld.exe";
                    ...
                    var command1 = "/C " + @"MySQL\bin\mysql -u root --password=root acore_auth <" + @"MySQL\bin\AccountBackup\AuthDB.sql";
                    ...
                    var mysql2 = new Process();
                    var command2 = "/C " + @"MySQL\bin\mysql -u root --password=root acore_characters <" + @"MySQL\bin\AccountBackup\CharactersDB.sql";
