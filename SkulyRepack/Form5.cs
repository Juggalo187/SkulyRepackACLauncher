    ...
    public partial class Form5 : Form
    {
        ...
        private void Button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                webClient.DownloadFile("https://raw.githubusercontent.com/Juggalo187/Repack_updaterAC/main/BotsManual.html", @"updater\launcher\BotsManual.html");
                System.Diagnostics.Process.Start(@"updater\launcher\BotsManual.html");
            }
        }
        ...
        private void Button6_Click(object sender, EventArgs e)
        {
            ...
            if ((sqlcheck2.Length == 0))
            {
                ...
                if (b == DialogResult.Yes)
                {
                    ...
                    mysqldump.StartInfo.Arguments = "-u root --password=root  acore_world creature --result-file=" + @"updater\launcher\sql\NPCDeleteBots\backup\NPCBotsDump_world.sql";
                    mysqldump.StartInfo.UseShellExecute = true;
                    mysqldump.StartInfo.WindowStyle = ProcessWindowStyle.Hidden;
                    mysqldump.Start();
                    mysqldump.WaitForExit();
                    mysqldump.StartInfo.Arguments = "-u root --password=root acore_characters characters_npcbot --result-file=" + @"updater\launcher\sql\NPCDeleteBots\backup\NPCBotsDump_chars.sql";
                    mysqldump.StartInfo.UseShellExecute = true;
                    mysqldump.StartInfo.WindowStyle = ProcessWindowStyle.Hidden;
                    mysqldump.Start();
                    mysqldump.WaitForExit();
                ...
                if (f == DialogResult.Yes)
                {
                    ...
                    var deletebotscharstring = "/C " + @"MySQL\bin\mysql -u root --password=root acore_characters < " + @"updater\launcher\sql\NPCDeleteBots\delete_npcbot_chars.sql";
                    ...
                    var deletebotsworldstring = "/C " + @"MySQL\bin\mysql -u root --password=root acore_world < " + @"updater\launcher\sql\NPCDeleteBots\delete_npcbot_world.sql";
